...
public class JavaMethodsDemo1 {
	...
	// Declare a non-static method with void return type and no Params
	public void displayEmpName() {
		System.out.println("John Legend");
	}

	// Declare a non-static method with void return type and with one Param
	public void displayEmpName(String empName) {
		System.out.println(empName);
	}

	// Declare a non-static method with int return type and with no params
	...
	// Declare a non-static method with String return type and with two params
